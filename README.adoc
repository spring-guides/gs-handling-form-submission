...
can also use Gradle. It also shows values of `com.example` and `handling-form-submission`
...
In this case, we use http://www.thymeleaf.org/doc/html/Thymeleaf-Spring3.html[Thymeleaf],
